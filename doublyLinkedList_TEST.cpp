...
int main(){
	...
	DoublyLinkedList<int> anotherIncredibleList; //(*shudder*)
	for (i; i < 200; i++)
	...
	//Testing = operator
	DoublyLinkedList<int> theMasterOfLists = anotherIncredibleList;
	...
	DoublyLinkedList<int> lastTestList(testList);
